...
<body style="background-color:#212529;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                style="width:50%; background-color:rgba(0,0,0,.5); padding:5px 5px 5px 5px; border-radius:10px; box-shadow: 2px 2px 10px aqua;">
                <h1 style=" color:white;">About Us</h1>
            </div>
            <br><br><br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 3px 2px red;">Sachin Dhere</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> SKNCOE, Pune</b></p>
    </center>
