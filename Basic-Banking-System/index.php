...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        style="font-family:candara; font-size:18px; box-shadow: 0px 0px 10px 0px aqua;">
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px aqua; text-align:center;"><b>Welcome to <br> MY
                        Bank</b></p>
            </div>
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:white;"><b>Our Facilities</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#343a40; color:aqua; width: 90%; border-radius:30px; box-shadow:3px 3px 8px aqua; padding:20px 10px 20px 10px;">
                            ...
                            <h6> Click Here to view every customer of the bank.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            ...
                            <a href="send_money.php"><button type="button" class="btn btn-outline-light mybtn">Transfer
                                    Money</button></a><br>
                            <h6>Click Here to send money from your account.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            ...
                            <a href="check_blc.php"><button type="button" class="btn btn-outline-light mybtn">Check
                                    Balance</button></a><br>
                            <h6> Click Here to check the remaining balance in your account.</h6>
                        </div>
                    </div>
                </div>
            </div>
